...
15.times do
  Product.create(name: Faker::Cannabis.strain, price: %w(60 65 70 80 95 100 110 240 250).sample.to_i, activity: ["day trip", "dive"].sample, capacity: (60..110).to_a.sample, status: [true, false].sample, description: Faker::Lorem.sentence(word_count: 25, supplemental: true), company: Company.all.sample)
end
