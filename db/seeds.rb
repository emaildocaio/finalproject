...
ShoppingCart.create(voucher: "0001", status: "pendente", user_id: User.all[-1].id)
ShoppingCart.create(voucher: "0002", status: "pago", user_id: User.all[-2].id)
ShoppingCart.create(voucher: "0003", status: "cancelado", user_id: User.all[-3].id)
ShoppingCart.create(voucher: "0004", status: "pago", user_id: User.all[-4].id)
...
booking1 = Booking.create(shopping_cart: ShoppingCart.all[-4], product: Product.all[-1], date: "2020-10-12", participants: 2)
booking1.price = booking1.product.price * booking1.participants

booking2 = Booking.create(shopping_cart: ShoppingCart.all[-3], product: Product.all[-2], date: "2020-10-12", participants: 1)
booking3.price = booking2.product.price * booking2.participants

booking3 = Booking.create(shopping_cart: ShoppingCart.all[-2], product: Product.all[-1], date: "2020-10-12", participants: 4)
booking3.price = booking3.product.price * booking3.participants
